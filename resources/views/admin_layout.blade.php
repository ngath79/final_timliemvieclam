...
<div class="top-nav clearfix">
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img alt="" src="{{('public/frontend/images/avata.png')}}">
                <span class="username">
                <?php
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    <a href="javascript:;">
                        ...
                        <span>Danh mục Job</span>
                    </a>
                    <ul class="sub">
						<li><a href="typography.html">Thêm danh mục Job</a></li>
						<li><a href="glyphicon.html">Liệt kê danh mục Job</a></li>
 ...
 <!-- footer -->
		  <div class="footer">
			<div class="wthree-copyright">
			  <p>© 2024  | Design by <a href="http://nwork.com">NWork</a></p>
			</div>
		  </div>
  <!-- / footer -->
</section>
